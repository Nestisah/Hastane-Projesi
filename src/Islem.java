...
public class Islem {
    public static void main(String [] args) throws InterruptedException {
        Bashekim b=new Bashekim("Nesti Şah","Kuşdemir",1111,"Profesör","İç Hastalıkları",30);
        Kardiyoloji k=new Kardiyoloji("Nursima","Kuşdemir",2222,"Doçent");
        Noroloji n=new Noroloji("Kamile","Kuşdemir",3333,"Bursa Teknik Üniversitesi");
        ...
        while(true){
            ...
            while(true){
                if(secim.equals("0")){
                    ...
                    System.out.println("Kardiyoloji birimine hoşgeldiniz"
